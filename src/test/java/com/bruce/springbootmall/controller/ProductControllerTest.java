...
public class ProductControllerTest {
    ...
    public void deleteProduct_success() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .delete("/products/{productId}", 1003);
    ...
    public void getProducts() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.top", notNullValue()))
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.results", hasSize(5)))
                .andExpect(jsonPath("$.results[0].productId", equalTo(1007)))
                .andExpect(jsonPath("$.results[1].productId", equalTo(1006)))
                .andExpect(jsonPath("$.results[2].productId", equalTo(1008)))
                .andExpect(jsonPath("$.results[3].productId", equalTo(1005)))
                .andExpect(jsonPath("$.results[4].productId", equalTo(1003)));
    }
    ...
    public void getProducts_pagination() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.results", hasSize(5)))
                .andExpect(jsonPath("$.results[0].productId", equalTo(1006)))
                .andExpect(jsonPath("$.results[1].productId", equalTo(1005)));
    }
}